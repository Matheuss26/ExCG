...
float xMin = -24,xMax = 24, zMin = 12,zMax = 60;
float desiredFPS = 30;
float X = xMax, XL = xMax;
float Z = zMin, ZL = zMax;
...
void drawGrid(float xMax, float xStep, float xMin, float zMax, float zStep, float zMin);
